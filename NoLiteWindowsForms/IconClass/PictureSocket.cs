    ...
    public class PictureSocket:Device
    {
        ...
        public void CreatePictureSocket(int i, PictureBox pictureBox,SerialPort port, string devicesChannel, PictureDeviceOn _deviceOn, PictureDeviceOff _deviceoff, PictureDeviceNoConnection deviceNoConnection, string idDevices, string devicesName, string deviceType, TabPage tabPage,Label srf13000T, Label tempT, Label tempMaxT,TabControl tabControl)
        {
            if (deviceType.Equals(SUF1300) || deviceType.Equals(SRF101000))
            {
                ...
                pct_socet.MouseUp += delegate (object sender, MouseEventArgs e) { eventClass.Btn_MouseUp(sender, e, port, pictureBox, _deviceOn, _deviceoff, deviceNoConnection, devicesChannel, idDevices, pct_socet, devicesName, deviceType, tabPage, srf13000T, tabControl); };
            ...
            if (deviceType.Equals(SRF13000) || deviceType.Equals(SRF13000M))
            {
                ...
                pct_light.MouseUp += delegate (object sender, MouseEventArgs e) { eventClass.Btn_MouseUp(sender, e, port, pictureBox, _deviceOn, _deviceoff, deviceNoConnection, devicesChannel, idDevices, pct_light, devicesName, deviceType, tabPage, srf13000T, tabControl); };
                pictureBox.Controls.Add(pct_light);
            }
            if (deviceType.Equals(SRF13000T))
            {
                CreateLabelForSRF13000T(i, pictureBox,port, devicesChannel, _deviceOn, _deviceoff, deviceNoConnection,idDevices,devicesName,deviceType,tabPage,srf13000T,tempT, tempMaxT, tabControl);
            ...
            if (deviceType.Equals(SRF11000R))
            {
                PictureBox pct_roll = new PictureBox
                {
                    ...
                    pct_roll.MouseUp += delegate (object sender, MouseEventArgs e) { eventClass.Btn_MouseUp(sender, e, port, pictureBox, _deviceOn, _deviceoff, deviceNoConnection, devicesChannel, idDevices, pct_roll, devicesName, deviceType, tabPage, srf13000T, tabControl); };                         
        ...
        public void CreateLabelForSRF13000T(int i, PictureBox pictureBox, SerialPort port, string devicesChannel, PictureDeviceOn _deviceOn, PictureDeviceOff _deviceoff, PictureDeviceNoConnection deviceNoConnection, string idDevices, string devicesName, string deviceType, TabPage tabPage, Label srf13000T, Label tempT, Label tempMaxT,TabControl tabControl)
        {
            ...
            PictureBox pct_socet = new PictureBox
            {
                ...
                Top = 8,
                Left = 2,
                Image = Properties.Resources.temp2,
                BackColor = Color.White,
                SizeMode = PictureBoxSizeMode.Zoom
            };
            pct_socet.MouseClick += delegate (object sender, MouseEventArgs e) { eventClass.MenuItemSRF13000T_Setting(sender, e, port, pictureBox, devicesChannel, devicesName, idDevices, _deviceOn, _deviceoff, deviceNoConnection, srf13000T, i, tempT, tempMaxT, tabPage, tabControl); };
            pct_socet.MouseUp += delegate (object sender, MouseEventArgs e) { eventClass.Btn_MouseUp(sender, e, port, pictureBox, _deviceOn, _deviceoff, deviceNoConnection, devicesChannel, idDevices, pct_socet, devicesName, deviceType, tabPage, srf13000T, tabControl); };
